...
<div class="container">
	<div class="d-flex justify-content-between">
		<div class="players">
			...
			<div class="padding">
<!-- 			<ul style="text-align: left; border-bottom-style: solid;">
				<li><a class="navbar-brand" href="../profile.php"><img src="../img/profile-icon.png" width="30" height="30" class="d-inline-block align-top" alt=""><?=' '.$_COOKIE['user']?></a>
		    	</li>
		    	<li><a class="navbar-brand" href="../profile.php"><img src="../img/profile-icon.png" width="30" height="30" class="d-inline-block align-top" alt=""><?=' '.$_COOKIE['user']?></a>
		    	</li>
		    	<li><a class="navbar-brand" href="../profile.php"><img src="../img/profile-icon.png" width="30" height="30" class="d-inline-block align-top" alt=""><?=' '.$_COOKIE['user']?></a>
		...
		<div class="d-flex flex-column">
			<div class="bs" style="width: 100%; background: #615a55;">
					 <div class="d-flex flex-row">
						  <div class="p-2"><a href="#" style="color: #fff; text-decoration: none;"><img src="../img/game-content/1.png" width="20" alt=""> Этажи: 10</a></div>
						  <div class="p-2"><a href="#" style="color: #fff; text-decoration: none;"><img src="../img/game-content/2.png" width="20" alt=""> Укрепленные этажи: 3</a></div>
						  <div class="p-2"><a href="#" style="color: #fff; text-decoration: none;"><img src="../img/game-content/3.png" width="20" alt=""> Снаряды: 10</a></div>
						  <div class="p-2"><a href="#" style="color: #fff; text-decoration: none;"><img src="../img/game-content/4.png" width="20" alt=""> Кирпичи: 5 +1/5m</a></div>
					</div>
			</div>
		<canvas id="canvas" style="z-index: 10; background: black; width: 100vh; height: 100%;"></canvas>
		</div>
		<div class="chat">
			<div class="bs h2"><h2>Чат</h2></div>
			<div class="padding">
<!-- 			<ul style="text-align: left; margin-bottom: 10px;">
				<li><a class="navbar-brand" href="../profile.php"><img src="../img/profile-icon.png" width="30" height="30" class="d-inline-block align-top" alt=""><?=' '.$_COOKIE['user'].': '.'Привет'?></a>
		    	</li>
		    	<li><a class="navbar-brand" href="../profile.php"><img src="../img/profile-icon.png" width="30" height="30" class="d-inline-block align-top" alt=""><?=' '.$_COOKIE['user'].': '.'Привет'?></a>
		    	</li>
		    	<li><a class="navbar-brand" href="../profile.php"><img src="../img/profile-icon.png" width="30" height="30" class="d-inline-block align-top" alt=""><?=' '.$_COOKIE['user'].': '.'Привет'?></a>
